...
public class OptionKey {
    ...
    public static final class DefaultPreference {
         ...
         */
        public static final String DEFAULT_RECENT_ARTICLE_DISPLAY_COUNT = "10";

        /**
         * Default recent comment display count.
         */
        public static final String DEFAULT_RECENT_COMMENT_DISPLAY_COUNT = "10";

        /**
         * Default most used tag display count.
         */
        public static final String DEFAULT_MOST_USED_TAG_DISPLAY_COUNT = "20";

        /**
         * Default article list display count.
         */
        public static final String DEFAULT_ARTICLE_LIST_DISPLAY_COUNT = "20";

        /**
         * Default article list pagination window size.
         */
        public static final String DEFAULT_ARTICLE_LIST_PAGINATION_WINDOW_SIZE = "15";

        /**
         * Default most comment article display count.
         */
        public static final String DEFAULT_MOST_COMMENT_ARTICLE_DISPLAY_COUNT = "5";
         ...
         */
        public static final String DEFAULT_RELEVANT_ARTICLES_DISPLAY_COUNT = "5";

        /**
         * Default random articles display count.
         */
        public static final String DEFAULT_RANDOM_ARTICLES_DISPLAY_COUNT = "5";

        /**
         * Default external relevant articles display count.
         */
        public static final String DEFAULT_EXTERNAL_RELEVANT_ARTICLES_DISPLAY_COUNT = "5";

        /**
         * Most view articles display count.
         */
        public static final String DEFAULT_MOST_VIEW_ARTICLES_DISPLAY_COUNT = "5";
         ...
         */
        public static final String DEFAULT_FEED_OUTPUT_CNT = "10";
        ...
        //todo init DEFAULT_REPLY_NOTIFICATION_TEMPLATE
//        /**
//         * Logger.
//         */
